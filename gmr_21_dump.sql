CREATE DATABASE  IF NOT EXISTS `gmr_21` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `gmr_21`;
-- MySQL dump 10.13  Distrib 5.6.10, for Win64 (x86_64)
--
-- Host: localhost    Database: gmr_21
-- ------------------------------------------------------
...
--
-- Table structure for table `cm_es`
--

DROP TABLE IF EXISTS `cm_es`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_es` (
  `target_concept` int(11) NOT NULL,
  ...
  KEY `target_concept_idx` (`target_concept`),
  KEY `source_concept_idx` (`source_concept`),
  CONSTRAINT `cm_target_concept0` FOREIGN KEY (`target_concept`) REFERENCES `target_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `cm_source_concept0` FOREIGN KEY (`source_concept`) REFERENCES `source_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_es`
--

LOCK TABLES `cm_es` WRITE;
/*!40000 ALTER TABLE `cm_es` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_es` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm_fa`
--

DROP TABLE IF EXISTS `cm_fa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_fa` (
  `target_concept` int(11) NOT NULL,
  ...
  KEY `target_concept_idx` (`target_concept`),
  KEY `source_concept_idx` (`source_concept`),
  CONSTRAINT `cm_target_concept00` FOREIGN KEY (`target_concept`) REFERENCES `target_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `cm_source_concept00` FOREIGN KEY (`source_concept`) REFERENCES `source_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_fa`
--

LOCK TABLES `cm_fa` WRITE;
/*!40000 ALTER TABLE `cm_fa` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_fa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm_ru`
--

DROP TABLE IF EXISTS `cm_ru`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_ru` (
  `target_concept` int(11) NOT NULL,
  ...
  KEY `target_concept_idx` (`target_concept`),
  KEY `source_concept_idx` (`source_concept`),
  CONSTRAINT `cm_target_concept000` FOREIGN KEY (`target_concept`) REFERENCES `target_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `cm_source_concept000` FOREIGN KEY (`source_concept`) REFERENCES `source_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_ru`
--

LOCK TABLES `cm_ru` WRITE;
/*!40000 ALTER TABLE `cm_ru` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_ru` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `lm_es`
--

DROP TABLE IF EXISTS `lm_es`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lm_es` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `source_concept_idx` (`source_concept`),
  KEY `target_concept_idx` (`target_concept`),
  KEY `lm_sentence0_idx` (`lm_sentence`),
  CONSTRAINT `lm_sentence0` FOREIGN KEY (`lm_sentence`) REFERENCES `lm_sentence_es` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_source_concept0` FOREIGN KEY (`source_concept`) REFERENCES `source_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_target_concept0` FOREIGN KEY (`target_concept`) REFERENCES `target_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lm_es`
--

LOCK TABLES `lm_es` WRITE;
/*!40000 ALTER TABLE `lm_es` DISABLE KEYS */;
/*!40000 ALTER TABLE `lm_es` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lm_fa`
--

DROP TABLE IF EXISTS `lm_fa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lm_fa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `source_concept_idx` (`source_concept`),
  KEY `target_concept_idx` (`target_concept`),
  KEY `lm_sentence1_idx` (`lm_sentence`),
  CONSTRAINT `lm_sentence1` FOREIGN KEY (`lm_sentence`) REFERENCES `lm_sentence_fa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_source_concept1` FOREIGN KEY (`source_concept`) REFERENCES `source_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_target_concept1` FOREIGN KEY (`target_concept`) REFERENCES `target_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lm_fa`
--

LOCK TABLES `lm_fa` WRITE;
/*!40000 ALTER TABLE `lm_fa` DISABLE KEYS */;
/*!40000 ALTER TABLE `lm_fa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lm_ru`
--

DROP TABLE IF EXISTS `lm_ru`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lm_ru` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `source_concept_idx` (`source_concept`),
  KEY `target_concept_idx` (`target_concept`),
  KEY `lm_sentence2_idx` (`lm_sentence`),
  CONSTRAINT `lm_sentence2` FOREIGN KEY (`lm_sentence`) REFERENCES `lm_sentence_ru` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_source_concept2` FOREIGN KEY (`source_concept`) REFERENCES `source_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_target_concept2` FOREIGN KEY (`target_concept`) REFERENCES `target_concept` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `lm_ru`
--

LOCK TABLES `lm_ru` WRITE;
/*!40000 ALTER TABLE `lm_ru` DISABLE KEYS */;
/*!40000 ALTER TABLE `lm_ru` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `lm_sentence_es`
--

DROP TABLE IF EXISTS `lm_sentence_es`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lm_sentence_es` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `text` mediumtext NOT NULL,
  `url` varchar(120) NOT NULL,
  `type` varchar(45) NOT NULL,
...
--
-- Dumping data for table `lm_sentence_es`
--

LOCK TABLES `lm_sentence_es` WRITE;
/*!40000 ALTER TABLE `lm_sentence_es` DISABLE KEYS */;
/*!40000 ALTER TABLE `lm_sentence_es` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lm_sentence_fa`
--

DROP TABLE IF EXISTS `lm_sentence_fa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lm_sentence_fa` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `text` mediumtext NOT NULL,
  `url` varchar(120) NOT NULL,
  `type` varchar(45) NOT NULL,
...
--
-- Dumping data for table `lm_sentence_fa`
--

LOCK TABLES `lm_sentence_fa` WRITE;
/*!40000 ALTER TABLE `lm_sentence_fa` DISABLE KEYS */;
/*!40000 ALTER TABLE `lm_sentence_fa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lm_sentence_ru`
--

DROP TABLE IF EXISTS `lm_sentence_ru`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lm_sentence_ru` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `text` mediumtext NOT NULL,
  `url` varchar(120) NOT NULL,
  `type` varchar(45) NOT NULL,
...
--
-- Dumping data for table `lm_sentence_ru`
--

LOCK TABLES `lm_sentence_ru` WRITE;
/*!40000 ALTER TABLE `lm_sentence_ru` DISABLE KEYS */;
/*!40000 ALTER TABLE `lm_sentence_ru` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-09-21 11:49:37
