...
--
-- Host: localhost    Database: gmr_44
-- ------------------------------------------------------
...
--
-- Table structure for table `cm2lm_core_case`
--

DROP TABLE IF EXISTS `cm2lm_core_case`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm2lm_core_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cm_id` int(11) NOT NULL,
  `lm_id` int(11) NOT NULL,
  `core_score` float NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `lm_core_idx` (`lm_id`),
  KEY `cm_core_case_idx` (`cm_id`),
  CONSTRAINT `cm_core_case` FOREIGN KEY (`cm_id`) REFERENCES `cm_case` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_core_case` FOREIGN KEY (`lm_id`) REFERENCES `lm` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm2lm_core_case`
--

LOCK TABLES `cm2lm_core_case` WRITE;
/*!40000 ALTER TABLE `cm2lm_core_case` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm2lm_core_case` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm2lm_core_general`
--

DROP TABLE IF EXISTS `cm2lm_core_general`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm2lm_core_general` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cm_id` int(11) NOT NULL,
  `lm_id` int(11) NOT NULL,
  `core_score` float NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `cm_core_idx` (`cm_id`),
  KEY `lm_core_idx` (`lm_id`),
  CONSTRAINT `cm_core_general` FOREIGN KEY (`cm_id`) REFERENCES `cm_general` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `lm_core_general` FOREIGN KEY (`lm_id`) REFERENCES `lm` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm2lm_core_general`
--

LOCK TABLES `cm2lm_core_general` WRITE;
/*!40000 ALTER TABLE `cm2lm_core_general` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm2lm_core_general` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cm_case` (
  ...
  CONSTRAINT `cm_source_case` FOREIGN KEY (`cm_source_id`) REFERENCES `cm_source` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `protagonist_case` FOREIGN KEY (`protagonist_id`) REFERENCES `protagonist` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_case`
--

LOCK TABLES `cm_case` WRITE;
/*!40000 ALTER TABLE `cm_case` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_case` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm_case_property`
--

DROP TABLE IF EXISTS `cm_case_property`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_case_property` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cm_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `cm_property_case_idx` (`cm_id`),
  CONSTRAINT `cm_property_case` FOREIGN KEY (`cm_id`) REFERENCES `cm_case` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_case_property`
--

LOCK TABLES `cm_case_property` WRITE;
/*!40000 ALTER TABLE `cm_case_property` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_case_property` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm_general`
--

DROP TABLE IF EXISTS `cm_general`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_general` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `language` enum('EN','ES','FA','RU') NOT NULL,
  ...
  KEY `cm_source_idx` (`cm_source_id`),
  KEY `protagonist_idx` (`protagonist_id`),
  KEY `cm_target_general_cm_idx` (`cm_target_general_id`),
  CONSTRAINT `cm_source_general` FOREIGN KEY (`cm_source_id`) REFERENCES `cm_source` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `protagonist_general` FOREIGN KEY (`protagonist_id`) REFERENCES `protagonist` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_general`
--

LOCK TABLES `cm_general` WRITE;
/*!40000 ALTER TABLE `cm_general` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_general` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cm_general_property`
--

DROP TABLE IF EXISTS `cm_general_property`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cm_general_property` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cm_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `value` varchar(45) NOT NULL,
  ...
  CONSTRAINT `cm_property` FOREIGN KEY (`cm_id`) REFERENCES `cm_general` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cm_general_property`
--

LOCK TABLES `cm_general_property` WRITE;
/*!40000 ALTER TABLE `cm_general_property` DISABLE KEYS */;
/*!40000 ALTER TABLE `cm_general_property` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `protagonist` VALUES (1,'GOV','GENERAL','A dummy used with non case specific LMs and CMs.',1),(2,'GOV','INDIVIDUAL_OVERSIGHT','Those in favor of individual oversight.',2),(3,'GOV','GOVERNMENT_OVERSIGHT','Those in favor of Federal Government oversight.',2);
...
-- Dump completed on 2014-10-10 11:40:19
