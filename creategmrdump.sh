...
# Regression tests add a suffix, so remove this for a true date
DATESTAMP="${DSTAMP:0:8}"
...
echo "INSERT INTO admin VALUES ('ICSI',$GMRVERSIONDEC,'$DATESTAMP',NULL);" | mysql -u mnadmin $DBNAME
